...
- **Mac 用户**：下载 [不记Todo-0.6.0-universal-mac.zip](https://github.com/yexinyu907/buji-todo/releases)，解压后双击打开即可
- **Windows 用户**：下载 [不记Todo 0.6.0.exe](https://github.com/yexinyu907/buji-todo/releases)，双击运行，无需安装
